...
export default function Dashboard({
    ...
    useEffect(() => {
        const updateTimelineHeight = () => {
            ...
            const shouldLockToHeroCard =
                visibleTimelineItems <= TIMELINE_BATCH_SIZE;
            ...
            const stableOffset =
                Math.abs(desiredOffset - timelineListOffset) > 0.5
                    ? desiredOffset
                    : timelineListOffset;
            ...
            const timelineActionsHeight = timelineActions
                ? timelineActions.getBoundingClientRect().height + 16
                : 0;
            const targetBottom = shouldLockToHeroCard
                ? heroCardRect.bottom
                : leftColumnRect.bottom;
            const availableHeight =
                targetBottom - alignedTop - timelineActionsHeight;
        ...
        <>
            ...
            <article className="p-dashboard">
                ...
                <main className="p-dashboard__main p-dashboard__container">
                    ...
                    {loading && (
                        <section
                            className="p-dashboard__loading"
                            aria-live="polite"
                            aria-busy="true"
                        >
                            <Alert className="p-dashboard__loading-alert">
                                ...
                                <AlertDescription>
                                    Estamos preparando prioridades, timeline y
                                    matriz en segundo plano.
                                </AlertDescription>
                            </Alert>
                    ...
                    {!loading && (
                        <section className="p-dashboard__grid">
                            <section
                                className="p-dashboard__left-column"
                                ref={leftColumnRef}
                            >
                                <section
                                    className="p-dashboard__label"
                                    aria-label="Prioridad actual"
                                >
                                    <span className="p-dashboard__label-text">
                                        Status: Prioridad critica
                                    </span>
                                    <i
                                        className="p-dashboard__label-marker"
                                        aria-hidden="true"
                                    />
                                </section>

                                <article
                                    className="p-dashboard__hero"
                                    ref={heroCardRef}
                                >
                                    <section className="p-dashboard__hero-main">
                                        <header className="p-dashboard__hero-head">
                                            <span className="p-dashboard__hero-tag">
                                                {hero.reference}
                                            </span>
                                            <p className="p-dashboard__hero-priority">
                                                •{' '}
                                                {hero.highlight ||
                                                    'PRIORIDAD ALTA'}
                                            </p>
                                        ...
                                        <section className="p-dashboard__hero-meta">
                                            <section className="p-dashboard__hero-kpi">
                                                <small className="p-dashboard__hero-kpi-label">
                                                    Tiempo restante
                                                </small>
                                                <b className="p-dashboard__hero-kpi-value p-dashboard__hero-kpi-value--critical">
                                                    {hero.remaining}
                                                </b>
                                            </section>
                                            <span
                                                className="p-dashboard__hero-divider"
                                                aria-hidden="true"
                                            />
                                            <section className="p-dashboard__hero-kpi">
                                                <small className="p-dashboard__hero-kpi-label">
                                                ...
                                                <b className="p-dashboard__hero-kpi-value">
                                                    {hero.priority}
                                                </b>
                                            </section>
                                        </section>
                                    ...
                                    <aside
                                        className="p-dashboard__hero-side"
                                        aria-hidden="true"
                                    >
                                        <svg
                                        ...
                                        >
                                            <defs>
                                                <radialGradient
                                                    id="dashboardHeroCoreGlow"
                                                    cx="0"
                                                    cy="0"
                                                    r="1"
                                                    gradientUnits="userSpaceOnUse"
                                                    gradientTransform="translate(110 110) rotate(90) scale(86)"
                                                >
                                                    <stop
                                            ...
                                            <circle
                                                ...
                                                cy="110"
                                                r="86"
                                                fill="url(#dashboardHeroCoreGlow)"
                                            />
                                            <circle
                                                className="p-dashboard__hero-art-core-ring"
                                                cx="110"
                                                cy="110"
                                                r="52"
                                            />
                                            <circle
                                                className="p-dashboard__hero-art-core-ring p-dashboard__hero-art-core-ring--inner"
                                                cx="110"
                                                cy="110"
                                                r="34"
                                            />
                                            <circle
                                                className="p-dashboard__hero-art-core"
                                                cx="110"
                                                cy="110"
                                                r="14"
                                            />
                                            ...
                                            <g className="p-dashboard__hero-art-orbit">
                                                <circle
                                                    className="p-dashboard__hero-art-orb"
                                                    cx="162"
                                                    cy="110"
                                                    r="7"
                                                />
                                            ...
                                            <g className="p-dashboard__hero-art-sparkles">
                                                <circle
                                                    className="p-dashboard__hero-art-sparkle"
                                                    cx="70"
                                                    cy="76"
                                                    r="1.8"
                                                />
                                        ...
                                        <span className="p-dashboard__hero-index">
                                            01
                                        </span>
                                    </aside>
                                </article>
                                ...
                                >
                                    <header className="p-dashboard__quick-header">
                                        <section>
                                            <h3
                                                id="quick-view-title"
                                                className="p-dashboard__quick-title"
                                            >
                                                Vista rapida
                                            </h3>
                                            <p className="p-dashboard__quick-subtitle">
                                                Progreso del semestre actual
                                            </p>
                                        </section>
                                        <section
                                            className="p-dashboard__quick-actions"
                                            aria-label="Acciones de asignaturas"
                                        >
                                            <Link
                                                className="p-dashboard__quick-link"
                                                href="/settings/security#apariencia"
                                            >
                                                Editar asignaturas
                                            </Link>
                                        </section>
                                        ...
                                        {quickCards.slice(0, 4).map((card) => (
                                            <Link
                                                ...
                                                className={[
                                                    ...
                                                    card.muted
                                                        ? 'p-dashboard__subject--muted'
                                                        : '',
                                                    card.accent
                                                        ? 'p-dashboard__subject--accent'
                                                        : '',
                                                ]
                                                    .filter(Boolean)
                                                    .join(' ')}
                                            >
                                                <section className="p-dashboard__subject-top">
                                                    <section>
                                                        <small className="p-dashboard__subject-code">
                                                            {card.code}
                                                        </small>
                                                        <h4 className="p-dashboard__subject-title">
                                                            {card.title}
                                                        </h4>
                                                    </section>
                                                    <span
                                                        className="p-dashboard__dot"
                                                        aria-hidden="true"
                                                    />
                                                </section>
                                                <section className="p-dashboard__subject-bottom">
                                                    ...
                                                    <span
                                                        className="p-dashboard__subject-arrow"
                                                        aria-hidden="true"
                                                    >
                                                        →
                                                    </span>
                                        ...
                                        {quickCards.length === 0 && (
                                            <article className="p-dashboard__subject">
                                                <section className="p-dashboard__subject-top">
                                                    ...
                                                    <span
                                                        className="p-dashboard__dot p-dashboard__dot--muted"
                                                        aria-hidden="true"
                                                    />
                                                </section>
                                                <section className="p-dashboard__subject-bottom">
                                ...
                                <section
                                    className="p-dashboard__matrix"
                                    aria-labelledby="matrix-title"
                                >
                                    <header className="p-dashboard__matrix-header">
                                        <h3
                                            id="matrix-title"
                                            className="p-dashboard__matrix-title"
                                        >
                                            Matriz de Eisenhower
                                        </h3>
                                        <section
                                            className="p-dashboard__matrix-tools"
                                            aria-label="Herramientas de explicacion IA"
                                        >
                                            <nav
                                                className="p-dashboard__matrix-mode"
                                                aria-label="Selector de modo de matriz"
                                            >
                                                <Link
                                                    className={[
                                                        'p-dashboard__matrix-mode-link',
                                                        !isAiMode
                                                            ? 'p-dashboard__matrix-mode-link--active'
                                                            : '',
                                                    ]
                                                        .filter(Boolean)
                                                        .join(' ')}
                                            ...
                                            <small
                                                className={[
                                                    'p-dashboard__matrix-hint',
                                                    matrixProvider === 'ai' ||
                                                    matrixProvider === 'gemini'
                                                        ? 'p-dashboard__matrix-hint--ai'
                                                        : '',
                                                ]
                                                    .filter(Boolean)
                                                    .join(' ')}
                                    ...
                                    <p className="p-dashboard__matrix-mode-help">
                                        Usa{' '}
                                        <strong className="p-dashboard__matrix-mode-help-emphasis">
                                            Logica base
                                        </strong>{' '}
                                        para una priorizacion instantanea y
                                        estable. Cambia a{' '}
                                        <strong className="p-dashboard__matrix-mode-help-emphasis">
                                            IA asistida
                                        </strong>{' '}
                                        si quieres feedback personalizado por
                                        asignatura, contexto o preferencias
                                        concretas.
                                    </p>
                                    ...
                                    {isAiMode && (
                                        ...
                                        >
                                            <input
                                                type="hidden"
                                                name="matrix_mode"
                                                value={data.matrix_mode}
                                            />

                                            <label
                                                className="p-dashboard__matrix-ai-label"
                                                htmlFor="matrix-ai-api-key"
                                            >
                                                API key IA
                                            </label>
                                            <input
                                            ...
                                            {matrixExplanation &&
                                                ![
                                                    ...
                                                    'invalid-json',
                                                    'ai-idle',
                                                ].includes(matrixProvider) && (
                                                    <article
                                                        className="p-dashboard__matrix-feedback"
                                                        aria-label="Explicacion del analisis IA"
                                                    >
                                                        <small className="p-dashboard__matrix-feedback-label">
                                                            ENFOQUE APLICADO
                                                        </small>
                                                        <p className="p-dashboard__matrix-feedback-text">
                                                            {matrixExplanation}
                                                        </p>
                                                    </article>
                                                )}
                                            ...
                                            <label
                                                className="p-dashboard__matrix-ai-check"
                                                htmlFor="matrix-ai-explanation"
                                            >
                                                <input
                                                    ...
                                                    type="checkbox"
                                                    checked={
                                                        data.matrix_include_explanation
                                                    }
                                                    onChange={(event) =>
                                                        setData(
                                                ...
                                                />
                                                <span className="p-dashboard__matrix-ai-check-text">
                                                    Incluir feedback explicativo
                                                    y recomendaciones por
                                                    cuadrante
                                                </span>
                                            </label>

                                            {(errors.ai_api_key ||
                                                errors.matrix_preferences) && (
                                                <p className="p-dashboard__matrix-ai-error">
                                                    {errors.ai_api_key ||
                                                        errors.matrix_preferences}
                                                </p>
                                            )}
                                            ...
                                            <button
                                                className="p-dashboard__matrix-ai-submit"
                                                type="submit"
                                                disabled={processing}
                                            >
                                                {processing
                                    ...
                                    <section className="p-dashboard__matrix-grid">
                                        <article
                                            className="p-dashboard__matrix-card p-dashboard__matrix-card--critical"
                                            aria-label="Urgente e importante"
                                        >
                                            <header className="p-dashboard__matrix-card-head">
                                                <strong className="p-dashboard__matrix-card-title">
                                                    Hacer ahora
                                                </strong>
                                                <small className="p-dashboard__matrix-card-subtitle">
                                                    Urgente
                                                </small>
                                            </header>
                                            <ul className="p-dashboard__matrix-list">
                                                {eisenhower.doNow.map(
                                                    (task) => (
                                                        <li
                                                            className="p-dashboard__matrix-item"
                                                            key={`do-now-${task.course}-${task.title}`}
                                                        >
                                                            <section className="p-dashboard__matrix-item-copy">
                                                                <h4 className="p-dashboard__matrix-item-title">
                                                                    {task.title}
                                                                </h4>
                                                                <p className="p-dashboard__matrix-item-course">
                                                                    {
                                                                        task.course
                                                                    }
                                                                </p>
                                                            ...
                                                            {task.link && (
                                                                <a
                                                                    className="p-dashboard__matrix-item-link"
                                                                    href={
                                                                        task.link
                                                                    }
                                                                    target="_blank"
                                                ...
                                                {eisenhower.doNow.length ===
                                                    0 && (
                                                    <li className="p-dashboard__matrix-item p-dashboard__matrix-item--empty">
                                                        Sin tareas criticas
                                                        detectadas
                                                    </li>
                                                )}
                                        ...
                                        <article
                                            className="p-dashboard__matrix-card"
                                            aria-label="No urgente e importante"
                                        >
                                            <header className="p-dashboard__matrix-card-head">
                                                <strong className="p-dashboard__matrix-card-title">
                                                    Programar
                                            ...
                                            <ul className="p-dashboard__matrix-list">
                                                {eisenhower.schedule.map(
                                                    (task) => (
                                                        <li
                                                            className="p-dashboard__matrix-item"
                                                            key={`schedule-${task.course}-${task.title}`}
                                                        >
                                                            <section className="p-dashboard__matrix-item-copy">
                                                                <h4 className="p-dashboard__matrix-item-title">
                                                                    {task.title}
                                        ...
                                        <article
                                            className="p-dashboard__matrix-card"
                                            aria-label="Urgente y menos importante"
                                        >
                                            <header className="p-dashboard__matrix-card-head">
                                                <strong className="p-dashboard__matrix-card-title">
                                                    Delegar
                                            ...
                                            <ul className="p-dashboard__matrix-list">
                                                {eisenhower.delegate.map(
                                                    (task) => (
                                                        <li
                                                            className="p-dashboard__matrix-item"
                                                            key={`delegate-${task.course}-${task.title}`}
                                                        >
                                                            <section className="p-dashboard__matrix-item-copy">
                                                                <h4 className="p-dashboard__matrix-item-title">
                                                                    {task.title}
                                        ...
                                        <article
                                            className="p-dashboard__matrix-card"
                                            aria-label="No urgente y menos importante"
                                        >
                                            <header className="p-dashboard__matrix-card-head">
                                                <strong className="p-dashboard__matrix-card-title">
                                                    Eliminar
                                            ...
                                            <ul className="p-dashboard__matrix-list">
                                                {eisenhower.optimize.map(
                                                    (task) => (
                                                        <li
                                                            className="p-dashboard__matrix-item"
                                                            key={`optimize-${task.course}-${task.title}`}
                                                        >
                                                            <section className="p-dashboard__matrix-item-copy">
                                                                <h4 className="p-dashboard__matrix-item-title">
                                                                    {task.title}
                            ...
                            <aside
                                className="p-dashboard__timeline"
                            ...
                            >
                                <header className="p-dashboard__timeline-header">
                                    <h2
                                        id="timeline-title"
                                        className="p-dashboard__timeline-title"
                                    >
                                        Linea de tiempo
                                    </h2>
                                </header>
                                ...
                                >
                                    {visibleTimeline.map((event, index) => (
                                        <li
                                            ...
                                            className={
                                                event.current
                                                    ? 'p-dashboard__timeline-item p-dashboard__timeline-item--current'
                                                    : 'p-dashboard__timeline-item'
                                            }
                                        >
                                            <p className="p-dashboard__timeline-time">
                                                {event.when}
                                            </p>
                                            <h4 className="p-dashboard__timeline-item-title">
                                                {event.title}
                                            </h4>
                                            ...
                                            {event.link && (
                                                <a
                                                    className="p-dashboard__timeline-link"
                                                    href={event.link}
                                                    target="_blank"
                                                    rel="noreferrer"
                                                >
                                ...
                                <div
                                    className="p-dashboard__timeline-actions"
                                    ref={timelineActionsRef}
                                >
                                    {canShowTimelineControls ? (
                                        ...
                                        <Link
                                            className="p-dashboard__timeline-more p-dashboard__timeline-more--ghost"
                                            href="/asignaturas"
                                        >
                                            Calendario completo
                                        </Link>
