            ...
            <main className="c-auth-editorial c-auth-editorial--register">
                <section
                    ...
                    style={
                        {
                            '--auth-hero-image':
                                'url("https://www.figma.com/api/mcp/asset/a1bb3190-6197-477b-b50f-66bef91760b5")',
                        } as CSSProperties
                    }
                >
                    <section className="c-auth-editorial__hero-content">
                        ...
                        <p className="c-auth-editorial__hero-description">
                            Unase a una infraestructura disenada para la
                            excelencia editorial. Un espacio donde la estructura
                            tecnica se encuentra con la vision intelectual.
                        </p>
                    </section>
                    ...
                    <article className="c-auth-editorial__panel c-auth-editorial__panel--register">
                        <header className="c-auth-editorial__header c-auth-editorial__header--register">
                            ...
                            <p className="c-auth-editorial__header-description">
                                Complete los detalles para iniciar su proceso
                                editorial.
                            </p>
                        </header>
                            ...
                            {({ processing, errors }) => (
                                <>
                                    <div className="c-auth-form__fields">
                                        ...
                                        <section
                                            className="c-auth-form__grid-two"
