    ...
    return (
        <>
            ...
            <main className="c-two-factor-auth-shell">
                <article
                    className="c-two-factor-auth"
                    aria-labelledby="two-factor-auth-title"
                >
                    <header
                        className="c-two-factor-auth__strip"
                        aria-hidden="true"
                    />

                    <section className="c-two-factor-auth__body">
                        <p className="c-two-factor-auth__eyebrow">
                            AUTENTICACIÓN
                        </p>

                        <h1
                            id="two-factor-auth-title"
                            className="c-two-factor-auth__title"
                        >
                            {showRecoveryInput ? (
                                <>
                                    Código de
                            ...
                            {({ errors, processing, clearErrors }) => (
                                <>
                                    {showRecoveryInput ? (
                                        ...
                                        <section
                                            className="c-two-factor-auth__otp-section"
                    ...
                    <footer
                        className="c-two-factor-auth__footer"
                        aria-label="Indicadores de estado tecnico"
                    >
                        <span className="c-two-factor-auth__footer-item">
                            -
                        </span>
                        <span className="c-two-factor-auth__footer-item">
                            ORGANIZAT
