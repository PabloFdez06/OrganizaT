            ...
            <div className="p-style-guide">
                ...
                <section className="p-style-guide__hero">
                    <div className="p-style-guide__hero-content">
                        ...
                        <p className="p-style-guide__hero-subtitle">
                            Guía de Estilos &amp; Design System
                        </p>
                        <div className="p-style-guide__hero-brand-line" />
                        <p className="p-style-guide__hero-version">
                            v1.0 · TFG DAW 2025–2026
                        </p>
                ...
                <section id="colores" className="p-style-guide__section">
                    <h2 className="p-style-guide__section-title">
                        01 — Colores
                    </h2>
                    <p className="p-style-guide__section-desc">
                        El sistema de color usa CSS custom properties con
                        soporte Light/Dark mode. La brand color (#6A1CF6) define
                    ...
                    <h3 className="p-style-guide__label">
                    ...
                    <p className="p-style-guide__gradient-label">
                        Gradiente Hero (Auth): #6a1cf6 → #1a0c5c → #061739
                    </p>
                ...
                <section id="tipografia" className="p-style-guide__section">
                    ...
                    <div className="p-style-guide__font-card">
                        <span
                            className="p-style-guide__font-card-name"
                            style={{
                        ...
                        <span className="p-style-guide__font-card-meta">
                            Sans-serif principal · --font-sans
                        </span>
                        <span className="p-style-guide__font-card-meta">
                    ...
                    <div className="p-style-guide__type-scale">
                        <TypeRow
                            ...
                            size="48px / 3rem"
                            weight="Bold"
                            sample="Gestión académica inteligente"
                        />
                        <TypeRow
                            label="H2"
                            size="36px / 2.25rem"
                            weight="Bold"
                            sample="Dashboard principal"
                        />
                        <TypeRow
                            label="H3"
                            size="28px / 1.75rem"
                            weight="Bold"
                            sample="Asignaturas del curso"
                        />
                        <TypeRow
                            label="H4"
                            size="22px / 1.38rem"
                        ...
                        <TypeRow
                            ...
                            size="16px / 1rem"
                            weight="Regular"
                            sample="El texto de cuerpo debe ser legible y cómodo para lectura prolongada."
                        />
                        <TypeRow
                            label="Body M"
                            size="14px / 0.88rem"
                            weight="Regular"
                            sample="Descripción de tareas y recursos académicos de la plataforma."
                        />
                        <TypeRow
                            label="Body S / Caption"
                            size="12px / 0.75rem"
                            weight="Regular"
                            sample="Metadatos, etiquetas y textos secundarios"
                        />
                        <TypeRow
                            label="Label / Badge"
                            size="11px / 0.69rem"
                            weight="Bold"
                            sample="ACTIVO · PENDIENTE · ERROR"
                        />
                    </div>
                </section>
                ...
                <section id="espaciado" className="p-style-guide__section">
                    ...
                    <p className="p-style-guide__section-desc">
                        Sistema de espaciado basado en múltiplos de 4px (base
                        unit: 0.25rem). Usar tokens $space-N en SCSS.
                    </p>
                ...
                <section id="border-radius" className="p-style-guide__section">
                    ...
                    <div className="p-style-guide__radius-grid">
                        <RadiusCard
                            token="$radius-sm"
                            value="0.35rem / 5.6px"
                            desc="Elementos pequeños (badges, tooltips)"
                            radius="5.6px"
                        />
                        <RadiusCard
                            token="$radius-md"
                            value="0.55rem / 8.8px"
                            desc="Botones, inputs, chips"
                            radius="8.8px"
                        />
                        <RadiusCard
                            token="$radius-lg"
                            value="0.8rem / 12.8px"
                            desc="Cards, modales, dropdowns, overlays"
                            radius="12.8px"
                        />
                        <RadiusCard
                            token="circular"
                            value="50% / —"
                            desc="Avatares, iconos circulares"
                            radius="50%"
                        />
                    </div>
                </section>
                ...
                <section id="sombras" className="p-style-guide__section">
                    <h2 className="p-style-guide__section-title">
                        05 — Sombras y Elevación
                    </h2>
                    <div className="p-style-guide__shadow-grid">
                        <ShadowCard
                            token="$shadow-sm"
                            desc="Elevación baja — tooltips, chips"
                            value="0 1px 2px rgba(0,0,0,0.08)"
                            shadow="0 1px 2px rgba(0,0,0,0.08)"
                        />
                        <ShadowCard
                            token="$shadow-md"
                            desc="Elevación media — cards, dropdowns"
                            value="0 6px 20px rgba(0,0,0,0.12)"
                            shadow="0 6px 20px rgba(0,0,0,0.12)"
                        />
                        <ShadowCard
                            token="dropdown"
                            desc="Elevación alta — modales, overlays"
                            value="0 12px 28px rgba(0,0,0,0.16)"
                            shadow="0 12px 28px rgba(0,0,0,0.16)"
                        />
                        <div className="p-style-guide__shadow-card p-style-guide__shadow-card--focus">
                            <span className="p-style-guide__shadow-card-token">
                                focus ring
                            </span>
                            <span className="p-style-guide__shadow-card-desc">
                                Focus ring accesibilidad — #8AB6FF
                            </span>
                            <span className="p-style-guide__shadow-card-value">
                                outline 2px solid var(--color-ring), offset 2px
                            </span>
                        </div>
                    </div>
                </section>
                ...
                <section id="breakpoints" className="p-style-guide__section">
                    ...
                    <div className="p-style-guide__bp-grid">
                        ...
                        <BpCard
                            ...
                            token="$bp-lg"
                            value="≥ 1024px"
                            desc="Tablet landscape / small laptop"
                            screenWidth="82%"
                        />
                        <BpCard
                            label="XL"
                ...
                <section id="motion" className="p-style-guide__section">
                    ...
                    <div className="p-style-guide__motion-grid">
                        <MotionCard
                            ...
                            duration="180ms"
                            easing="ease"
                            desc="Buttons, inputs, hover states"
                            code="transition: 180ms ease"
                        />
                        <MotionCard
                            title="Prototype navigate"
                            duration="350ms"
                            easing="EASE_IN_AND_OUT"
                            desc="Navegación entre pantallas en Figma"
                            code="DISSOLVE · 0.35s"
                        />
                        <MotionCard
                            title="Prototype overlay"
                            duration="250ms"
                            easing="EASE_IN_AND_OUT"
                            desc="Aparición de overlays (notificaciones)"
                            code="DISSOLVE · 0.25s"
                        />
                        <MotionCard
                            title="Focus ring"
                            duration="—"
                            easing="—"
                            desc="Inmediato — no animar foco por a11y"
                ...
                <section id="accesibilidad" className="p-style-guide__section">
                    <h2 className="p-style-guide__section-title">
                        09 — Accesibilidad (WCAG 2.1)
                    </h2>
                    <div className="p-style-guide__a11y-grid">
                        <A11yCard
                            title="Focus ring visible"
                            desc="outline: 2px solid var(--color-ring), offset: 2px — Mixin @include focus-ring"
                            wcag="WCAG 2.4.7 AA"
                        />
                        <A11yCard
                            title="Jerarquía de encabezados"
                            desc="H1 → H2 → H3 estrictamente. No saltar niveles. Un H1 por página."
                            wcag="WCAG 1.3.1 A"
                        />
                        <A11yCard
                            title="Contraste de texto"
                            desc="Color text #12161f / bg #fbfcff: ratio ~17:1 (AAA). Brand #6a1cf6 sobre blanco: ratio ~4.8:1 (AA)"
                            wcag="WCAG 1.4.3 AA"
                        />
                        <A11yCard
                            title="Labels en formularios"
                            desc="Siempre <label for> asociado o aria-label. Nunca placeholder como único label."
                            wcag="WCAG 1.3.1 A"
                        />
                        <A11yCard
                            title="Semántica HTML estricta"
                            desc="Metodología BEM. Tags semánticos: <nav>, <main>, <header>, <section>, <article>. Evitar <div> innecesario."
                            wcag="WCAG 4.1.2 A"
                        />
                        <A11yCard
                            title="Navegación por teclado"
                            desc="Tab order lógico. Botones y links accesibles con Enter/Space. No keyboard traps."
                            wcag="WCAG 2.1.1 A"
                        />
                        <A11yCard
                            title="Color como único diferenciador"
                            desc="EVITAR usar solo color para transmitir información. Usar también iconos, texto, o patrones."
                            wcag="WCAG 1.4.1 A"
                            variant="red"
                        />
                        <A11yCard
                            title="Texto alt en imágenes"
                            desc='Todas las imágenes informativas con alt descriptivo. Decorativas con alt="".'
                            wcag="WCAG 1.1.1 A"
                        />
                    </div>
                </section>
                ...
                <footer className="p-style-guide__footer">
                    <p className="p-style-guide__footer-title">
                        ORGANIZAT Design System · Guía de Estilos v1.0 · TFG DAW
                        2025–2026
                    </p>
                    <p className="p-style-guide__footer-meta">
                        Tokens extraídos de resources/scss/1-settings/ · Color
                        system: Light/Dark mode · Font: Space Grotesk · Base
                        unit: 4px (0.25rem)
                    </p>
                </footer>
            </div>
...
function ColorSwatch({ color, name }: { color: string; name: string }) {
    return (
        <div className="p-style-guide__swatch">
            <div
                className="p-style-guide__swatch-box"
...
function TypeRow({
    ...
    return (
        <div className="p-style-guide__type-row">
            ...
            <div
                className="p-style-guide__type-row-sample"
                style={{ fontSize, fontWeight: fw }}
            >
                {sample}
            </div>
        </div>
...
function SpaceBlock({
    ...
    return (
        <div className="p-style-guide__space-item">
            <div
                className="p-style-guide__space-block"
...
function RadiusCard({
    ...
    return (
        <div className="p-style-guide__radius-card">
            <div
                className="p-style-guide__radius-card-box"
...
function ShadowCard({
    ...
    return (
        <div
            className="p-style-guide__shadow-card"
...
function BpCard({
    ...
    return (
        <div className="p-style-guide__bp-card">
            <div
                className="p-style-guide__bp-card-box"
...
function MotionCard({
    ...
    return (
        <div className="p-style-guide__motion-card">
            <strong className="p-style-guide__motion-card-title">
                {title}
            </strong>
            <span className="p-style-guide__motion-card-duration">
                Duración: {duration}
            </span>
            <span className="p-style-guide__motion-card-easing">
                Easing: {easing}
            </span>
...
function A11yCard({
    ...
    return (
        <div
            className={`p-style-guide__a11y-card${variant === 'red' ? ' p-style-guide__a11y-card--danger' : ''}`}
        >
            <strong className="p-style-guide__a11y-card-title">
                ● {title}
            </strong>
        ...
        <>
            ...
            <div className="p-style-guide__btn-row">
                <div className="p-style-guide__btn-demo">
                    <button className="p-style-guide__btn p-style-guide__btn--primary">
                        Primary
                    </button>
                    <span className="p-style-guide__btn-meta">
                        .c-button--primary
                        <br />
                        sm (32px)
                        <br />
                ...
                <div className="p-style-guide__btn-demo">
                    <button className="p-style-guide__btn p-style-guide__btn--secondary">
                        Secondary
                    </button>
                    <span className="p-style-guide__btn-meta">
                        .c-button--secondary
                ...
                <div className="p-style-guide__btn-demo">
                    <button className="p-style-guide__btn p-style-guide__btn--outline">
                        Outline
                    </button>
                    <span className="p-style-guide__btn-meta">
                        .c-button--outline
                ...
                <div className="p-style-guide__btn-demo">
                    <button className="p-style-guide__btn p-style-guide__btn--danger">
                        Danger
                    </button>
                    <span className="p-style-guide__btn-meta">
                        .c-button--danger
                ...
                <div className="p-style-guide__btn-demo">
                    <button className="p-style-guide__btn p-style-guide__btn--ghost">
                        Ghost
                    </button>
                    <span className="p-style-guide__btn-meta">
                        .c-button--ghost
                ...
                <div className="p-style-guide__btn-demo">
                    <button className="p-style-guide__btn p-style-guide__btn--link">
                        Link
                    </button>
                    <span className="p-style-guide__btn-meta">
                        .c-button--link
                ...
                <div className="p-style-guide__btn-demo">
                    <button
                        className="p-style-guide__btn p-style-guide__btn--disabled"
                        disabled
                    >
                        Disabled
                    </button>
            ...
            <div className="p-style-guide__input-row">
                <div className="p-style-guide__input-demo">
                    <input
                        className="p-style-guide__input"
                ...
                <div className="p-style-guide__input-demo">
                    <input
                        className="p-style-guide__input p-style-guide__input--focused"
                        placeholder="Ejemplo de texto..."
                        readOnly
                    />
                ...
                <div className="p-style-guide__input-demo">
                    <input
                        className="p-style-guide__input p-style-guide__input--error"
                        placeholder="Ejemplo de texto..."
                        readOnly
                    />
                ...
                <div className="p-style-guide__input-demo">
                    <input
                        className="p-style-guide__input p-style-guide__input--dark"
                        placeholder="Ejemplo de texto..."
                        readOnly
                    />
            ...
            <div className="p-style-guide__cards-row">
                <div className="p-style-guide__card-demo">
                    ...
                    <p>
                        border-radius: $radius-lg (0.8rem)
                        <br />
                        border: 1px solid var(--color-border)
                        <br />
                        padding: $space-4 $space-5 (1rem 1.2rem)
                    </p>
                </div>
                <div className="p-style-guide__card-demo p-style-guide__card-demo--alert">
                    <strong>Alert — .c-alert--danger</strong>
                    <p>
                        Fondo: var(--color-danger-soft)
                        <br />
                        Borde: var(--color-danger)
                    </p>
                </div>
            ...
            <div className="p-style-guide__badge-row">
                <span className="p-style-guide__badge p-style-guide__badge--success">
                    Activo
                </span>
                <span className="p-style-guide__badge p-style-guide__badge--warning">
                    Pendiente
                </span>
                <span className="p-style-guide__badge p-style-guide__badge--error">
                    Error
                </span>
                <span className="p-style-guide__badge p-style-guide__badge--info">
                    Info
                </span>
                <span className="p-style-guide__badge p-style-guide__badge--warn-alt">
                    Advertencia
                </span>
            </div>

            <h3 className="p-style-guide__label">
                NAVEGACIÓN — .c-academia-header__nav-link
            </h3>
            <div className="p-style-guide__nav-demo">
                <span className="p-style-guide__nav-link p-style-guide__nav-link--active">
                    DASHBOARD
                </span>
            ...
            <p className="p-style-guide__nav-meta">
                letter-spacing: 1.2px · text-transform: uppercase · font-size:
                13px · font-weight: 600 · border-bottom: 2px solid
                var(--color-brand) on active
            </p>
            <p className="p-style-guide__nav-meta">
                HEADER — backdrop: blur(4px) · background: color-mix(in srgb,
                surface, transparent 15%) · border-bottom: 1px solid
                --color-border · height: 72px
            </p>
        </>
    );
}
...
function DosAndDonts() {
    const dos = [
        {
            title: 'Usar tokens CSS',
            desc: 'Siempre usar var(--color-brand), nunca hardcodear #6a1cf6 directamente en componentes.',
        },
        {
            title: 'Escala de espaciado',
            desc: 'Usar $space-N del sistema. Nunca inventar valores arbitrarios en px.',
        },
        {
            title: 'Semántica HTML',
            desc: 'Elegir siempre el tag correcto: <button> para acciones, <a> para navegación, <nav> para menús.',
        },
        {
            title: 'Focus ring',
            desc: 'Incluir @include focus-ring en todos los elementos interactivos para garantizar accesibilidad por teclado.',
        },
        {
            title: 'BEM consistente',
            desc: 'Bloque__Elemento--Modificador. Mantener nomenclatura clara y jerárquica en todos los componentes SCSS.',
        },
        {
            title: 'Tipografía semántica',
            desc: 'Usar <h1>-<h6> con jerarquía correcta. Solo un H1 por página. Respetar la escala tipográfica.',
        },
    ];
    const donts = [
        {
            title: 'NO hardcodear colores',
            desc: '❌ color: #6a1cf6   ✅ color: var(--color-brand)',
        },
        {
            title: 'NO usar px para espaciado',
            desc: '❌ padding: 16px   ✅ padding: $space-4 (1rem)',
        },
        {
            title: 'NO usar div genéricos',
            desc: '❌ <div class="nav">   ✅ <nav class="c-app-header__nav">',
        },
        {
            title: 'NO color como único indicador',
            desc: 'Siempre acompañar de icono, texto o patrón para estados de error/éxito.',
        },
        {
            title: 'NO romper jerarquía tipográfica',
            desc: '❌ H1 → H3 (saltarse H2)   ✅ H1 → H2 → H3 en orden.',
        },
        {
            title: 'NO fetch() en componentes Inertia',
            desc: 'Usar useForm o router.visit. Nunca fetch/axios para datos del propio backend.',
        },
    ];
        ...
        <div className="p-style-guide__dos-grid">
            {dos.map((d) => (
                <div key={d.title} className="p-style-guide__do-card">
                    <span className="p-style-guide__do-card-label">
                        ✓ HACER
                    </span>
            ...
            {donts.map((d) => (
                <div key={d.title} className="p-style-guide__dont-card">
                    <span className="p-style-guide__dont-card-label">
                        ✗ EVITAR
                    </span>
                    <strong>{d.title}</strong>
                    <p>{d.desc}</p>
