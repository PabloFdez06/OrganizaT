...
const features: FeatureItem[] = [
    ...
    },
    {
        ...
        description:
            'Archivos, actividades y foros en un panel limpio y sin ruido visual.',
        icon: <BooksIcon />,
    },
    {
        id: '003',
        ...
        description:
            'Tu rendimiento académico con gráficos claros y datos siempre actualizados.',
        icon: <PulseIcon />,
    },
    {
        id: '004',
    ...
    },
    {
        ...
        description:
            'Comunícate con profesores y compañeros sin abrir el navegador.',
        icon: <MessageIcon />,
    },
];
    ...
    useEffect(() => {
        ...
        if (!prefersReducedMotion && supportsCustomCursor && cursor && ring) {
            ...
            const interactiveElements = root.querySelectorAll<HTMLElement>(
                'a, button, .feat, .step, [role="button"]',
            );
            ...
            <main className="p-welcome" ref={pageRef}>
                ...
                <header>
                    <nav aria-label="Navegación principal">
                        <p className="logo">
                            Organiza<span>T</span>
                        </p>
                        <ul className="nav-right">
                            <li>
                                <a href="#feat" className="nav-link">
                                    Funciones
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href={accessHref} className="nav-btn">
                                    Acceder
                                </Link>
                            </li>
                        </ul>
                ...
                <section className="hero" aria-labelledby="welcome-hero-title">
                    ...
                    <article className="hero-left">
                        <p className="eyebrow">
                            ...
                            <span className="eyebrow-txt">
                                Plataforma educativa reimaginada
                            </span>
                        </p>
                        ...
                        >
                            ...
                            <p className="sub-txt">
                                Accede a todos tus cursos, calificaciones,
                                tareas y mensajes de Moodle desde una interfaz
                                moderna, rápida y unificada. Disponible en web y
                    ...
                    <aside
                        ...
                        aria-label="Vista previa de la aplicación móvil"
                    >
                        <article className="phone-scene">
                            <p className="ftag ftag-1" aria-hidden="true">
                                <span className="ftag-label">
                                    Progreso global
                                </span>
                                <span className="ftag-val">
                                    <em>73%</em> completado
                                </span>
                            </p>
                                        ...
                                        <section className="p-status">
                                            ...
                                            <span className="p-icons">
                                                ...
                                                <svg
                                                    ...
                                                    opacity="0.85"
                                                >
                                                    <path d="M6.5 2.5C8.4 2.5 10.1 3.3 11.3 4.6L12.2 3.7C10.7 2.1 8.7 1 6.5 1S2.3 2.1.8 3.7l.9.9C2.9 3.3 4.6 2.5 6.5 2.5z" />
                                                    <path d="M6.5 5c1.2 0 2.3.5 3.1 1.3L10.5 5.4C9.4 4.3 8 3.6 6.5 3.6S3.6 4.3 2.5 5.4l.9.9C4.2 5.5 5.3 5 6.5 5z" />
                                                    <circle
                                                        cx="6.5"
                                                        cy="8.5"
                                                        r="1.4"
                                        ...
                                        <section className="p-body">
                                            ...
                                            <section className="p-task">
                                                <span className="p-task-l">
                                                    <span className="p-task-tag">
                                                        Entrega urgente
                                                    </span>
                                                    <span className="p-task-name">
                                                        Práctica 3 - Integrales
                                                    </span>
                                                </span>
                                                <span className="p-task-badge">
                                                    Hoy
                                                </span>
                                            </section>
                                        </section>
                ...
                <section
                    ...
                    aria-label="Compatibilidad y beneficios"
                >
                ...
                >
                    <span className="feat-bg-num" aria-hidden="true">
                        06
                    </span>
                    <header className="feat-header reveal">
                        ...
                        <p className="feat-intro">
                            Una interfaz que respeta tu tiempo y tu
                            inteligencia. Sin ruido, sin clics de más. Solo tu
                            información académica, presentada con precisión y
                            velocidad.
                        </p>
                    </header>
                    <section
                ...
                <section className="how" id="how" aria-labelledby="how-title">
                    <section className="how-inner">
                        <aside className="how-bar" aria-hidden="true">
                            <span className="how-bar-txt">
                                Cómo funciona el proceso de conexión
                            </span>
                        </aside>
                        <section className="how-body">
                            <h2 className="how-title reveal" id="how-title">
                                CONECTADO EN
                                <br />
                                <em>TRES PASOS.</em>
                            </h2>
                            ...
                            <section
                                ...
                                aria-label="Proceso de conexión"
                            >
                                {steps.map((step) => (
                            ...
                            <article
                                className="web-mock reveal"
                                aria-label="Vista previa web"
                            >
                                <header className="wb-bar">
                                    ...
                                    <span className="wb-url">
                                        OrganizaT.blete.tech / dashboard
                                    </span>
                                </header>
                                <section className="wb-body">
                                    <nav
                                        className="wb-side"
                                        aria-label="Menú lateral demo"
                                    >
                                    ...
                                    <section className="wb-main">
                                        <h3 className="wb-greet">
                                            Bienvenida, María García
                                        </h3>
                                        <p className="wb-sub">
                                            Martes, 18 de marzo - 3 entregas
                                            esta semana
                                        </p>
                ...
                >
                    <section className="dl-inner">
                        <article className="dl-left reveal">
                            <p className="dl-eye">
                                <span
                                    className="dl-eye-bar"
                                    aria-hidden="true"
                                />
                                <span className="dl-eye-txt">
                                    App móvil nativa
                                </span>
                            </p>
                            <h2 className="dl-title" id="download-title">
                                LLÉVALO
                                <br />
                                CONTIGO.
                            </h2>
                            <p className="dl-desc">
                                App gratuita para iOS y Android. Notificaciones
                                nativas, acceso a materiales y la misma
                                experiencia que en web, adaptada al móvil. Sin
                                publicidad.
                            </p>
                            <section
                        ...
                        <article className="dl-right reveal">
                            <section className="access-block">
                                <h3 className="access-label">
                                    Acceso web directo
                                </h3>
                                <article
                                    className="url-field"
                                    aria-label="Ejemplo de URL Moodle"
                                >
                                    <span className="url-mini">
                                        Tus credenciales de la moodle
                                    </span>
                                    <p className="url-val">
                                        username-<em>password</em>
                                    </p>
                                </article>
                ...
                <footer>
                    ...
                    <p className="f-copy">
                        2026 OrganizaT. Todos los derechos reservados.
                    </p>
                </footer>
            </main>
        </>
