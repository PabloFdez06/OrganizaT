...
const ArrowRightIcon = () => (
    <svg
        viewBox="0 0 12 12"
        className="p-error-404__action-icon"
        aria-hidden="true"
        focusable="false"
    >
        <path
...
export default function NotFound({
    ...
    const incidentReportError = (errors as Record<string, string | undefined>)
        .incident_report;

    const resolvedTimestamp = timestamp ?? new Date().toISOString();
    const resolvedServerNode = serverNode ?? 'ARCHIVE-CL-04';
    const footerYear = Number.isNaN(
        new Date(resolvedTimestamp).getUTCFullYear(),
    )
        ? '2024'
        ...
        post(store().url, {
            ...
            onSuccess: () => {
                setSubmissionFeedback({
                    type: 'success',
                    message:
                        'Reporte enviado correctamente. El modal se cerrará automáticamente.',
                });
                reset('description');
            ...
            onError: (formErrors) => {
                setSubmissionFeedback({
                    type: 'error',
                    message:
                        formErrors.incident_report ??
                        'No se pudo enviar el reporte. Revisa los campos e inténtalo de nuevo.',
                });
            },
        });
    };
        ...
        <>
            ...
            <main className="p-error-404" aria-labelledby="error-404-title">
                <section className="p-error-404__canvas">
                    <section
                        className="p-error-404__content"
                        aria-label="Mensaje tecnico de navegacion"
                    >
                        <p className="p-error-404__error-type">
                            ERROR_TYPE: NAVIGATION_FAILURE
                        </p>
                        <h1 id="error-404-title" className="p-error-404__code">
                            {status}
                        </h1>
                        ...
                        <header className="p-error-404__message-head">
                            <h2 className="p-error-404__title">
                                RUTA NO ENCONTRADA // ERROR_CODE: 0x404
                            </h2>
                            <p className="p-error-404__description">
                                Parece que el recurso o la seccion que buscas ha
                                sido archivada o no existe en nuestra base de
                                datos academica.
                            </p>
                        </header>

                        <nav
                            className="p-error-404__actions"
                            aria-label="Acciones de recuperacion"
                        >
                            <Link
                                href={dashboard()}
                                className="p-error-404__action p-error-404__action--primary"
                            >
                                VOLVER AL DASHBOARD
                                <ArrowRightIcon />
                            </Link>
                        ...
                        <dl className="p-error-404__meta">
                            <dt className="p-error-404__meta-label">
                                TIMESTAMP
                            </dt>
                            <dd className="p-error-404__meta-value">
                                {resolvedTimestamp}
                            </dd>
                            <dt className="p-error-404__meta-label">
                                SERVER_NODE
                    ...
                    <figure
                        className="p-error-404__visual"
                        aria-label="Composicion visual del estado de archivo"
                    >
                        <section
                            className="p-error-404__visual-panel"
                            aria-hidden="true"
                        />
                        <figcaption className="p-error-404__status-chip">
                            <span className="p-error-404__status-label">
                                STATUS
                            </span>
                            <span className="p-error-404__status-value">
                ...
                <footer
                    className="p-error-404__strip"
                    aria-label="Metadatos de sistema"
                >
                    <p className="p-error-404__strip-item p-error-404__strip-item--left">
                        <span
                            className="p-error-404__strip-dot"
                            aria-hidden="true"
                        />
                        CONEXION: CIFRADA
                    </p>
                    <p className="p-error-404__strip-item">
                        ORGANIZAT ACADEMIC FRAMEWORK v2.4.0
                    </p>
                    <p className="p-error-404__strip-item">
                        (C) {footerYear} EDITORIAL ARCHIVE
                    </p>
                </footer>
            </main>
            ...
            <Dialog
                ...
                onOpenChange={handleIncidentModalChange}
            >
                <DialogContent className="p-error-404__modal">
                    <DialogHeader>
                        <DialogTitle className="p-error-404__modal-title">
                            Reportar incidencia 404
                        </DialogTitle>
                        <DialogDescription className="p-error-404__modal-description">
                            Cuéntanos qué estabas intentando hacer y te
                            responderemos por correo.
                        </DialogDescription>
                    </DialogHeader>

                    <form
                        className="p-error-404__modal-form"
                    ...
                    >
                        <section className="p-error-404__modal-field">
                            ...
                            <InputError
                                message={
                                    incidentClientErrors.name ||
                                    translateServerError(errors.name)
                                }
                            />
                        </section>
                        ...
                        <section className="p-error-404__modal-field">
                            ...
                            <InputError
                                message={
                                    incidentClientErrors.email ||
                                    translateServerError(errors.email)
                                }
                            />
                        </section>
                        ...
                        <section className="p-error-404__modal-field">
                            ...
                            <InputError
                                message={
                                    incidentClientErrors.description ||
                                    translateServerError(errors.description)
                                }
                            />
                        </section>
                        ...
                        <DialogFooter className="p-error-404__modal-footer">
                            ...
                            <Button
                                type="submit"
                                className="p-error-404__modal-btn p-error-404__modal-btn--primary"
                                disabled={processing}
                            >
                                {processing && (
                                    <Spinner className="p-error-404__modal-spinner" />
                                )}
                                Enviar reporte
                            </Button>
                        </DialogFooter>
