...
const EXACT: Record<string, string> = {
    ...
    'auth.throttle':
        'Demasiados intentos de acceso. Por favor, espera unos segundos.',
    ...
    'The moodle_username field is required.':
        'El usuario de Moodle es obligatorio.',
    'The moodle_password field is required.':
        'La contraseña de Moodle es obligatoria.',
    'Credenciales Moodle inválidas.':
        'Las credenciales de Moodle son incorrectas.',
    'No se pudo conectar con Moodle.':
        'No se pudo conectar con Moodle. Comprueba tus datos.',
    'Invalid Moodle credentials.':
        'Las credenciales de Moodle son incorrectas.',
    'CAS login succeeded but sesskey could not be extracted.':
        'El inicio de sesión se completó, pero no se pudo verificar la sesión. Inténtalo de nuevo.',
    'Missing Moodle/CAS configuration.':
        'Error de configuración del servidor Moodle. Contacta con el administrador.',
    'Moodle request failed after retries.':
        'No se pudo conectar con Moodle tras varios intentos. Comprueba tu conexión.',
};
...
const PATTERNS: Array<[RegExp, (m: RegExpMatchArray) => string]> = [
    ...
    [/The .+ has already been taken\./, () => 'Este valor ya está en uso.'],
    [
