        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="p-settings__two-factor-modal">
                <header className="p-settings__two-factor-modal-close-row">
                    <button
                        type="button"
                        className="p-settings__two-factor-modal-close-button"
                        onClick={onClose}
                    >
                        CLOSE
                        <X aria-hidden="true" />
                ...
                <DialogHeader className="p-settings__two-factor-modal-header">
                    <DialogTitle className="p-settings__two-factor-modal-title">
                        {modalConfig.title}
                    </DialogTitle>
                ...
                {!shouldShowSetupData && (
                    <section className="p-settings__two-factor-empty">
                        <p>
                            Activa el 2FA desde la zona de peligro para cargar
                            automaticamente el QR, la clave manual y los codigos
                            de recuperacion.
                        </p>
                    </section>
                )}
                ...
                {shouldShowSetupData && (
                    <section
                        className="p-settings__two-factor-layout"
                        aria-live="polite"
                    >
                        <section className="p-settings__two-factor-left-column">
                            <section className="p-settings__two-factor-qr-card">
                                <div className="p-settings__two-factor-qr-frame">
                                    {isRefreshingSetup ? (
                                        ...
                                        <div
                                            className="p-settings__two-factor-qr-image"
                                            dangerouslySetInnerHTML={{
                                                __html: qrCodeSvg,
                                            }}
                                        />
                                    ) : (
                                        <p className="p-settings__two-factor-subtext">
                                            No se pudo cargar el QR.
                                        </p>
                                    )}
                                </div>

                                <p className="p-settings__two-factor-label">
                                    AUTHENTICATION ID
                                </p>
                                <p className="p-settings__two-factor-subtext">
                            ...
                            <section className="p-settings__two-factor-manual-section">
                                <h3 className="p-settings__two-factor-manual-title">
                                    MANUAL SETUP
                                </h3>
                                <div className="p-settings__two-factor-manual-row">
                                    <code className="p-settings__two-factor-manual-code">
                        ...
                        <section className="p-settings__two-factor-right-column">
                            <section className="p-settings__two-factor-recovery-card">
                                <header className="p-settings__two-factor-recovery-header">
                                    <div>
                                        <h3 className="p-settings__two-factor-recovery-title">
                                            Codigos de recuperacion
                                        </h3>
                                        <p className="p-settings__two-factor-subtext">
                                            Guarda estos codigos en un lugar
                                            seguro.
                                        </p>
                                    </div>
                                    <Button
                                ...
                                <div className="p-settings__two-factor-recovery-list-wrapper">
                                    {recoveryCodesList.length > 0 ? (
                                        <ul
                                            className="p-settings__two-factor-recovery-list"
                                        ...
                                        >
                                            {recoveryCodesList.map(
                                                (recoveryCode, index) => (
                                                    <li
                                                        key={recoveryCode}
                                                        className="p-settings__two-factor-recovery-item"
                                                    >
                                                        ...
                                                        <span className="p-settings__two-factor-recovery-code">
                                                            {recoveryCode}
                                                        </span>
                                                    </li>
                                                ),
                            ...
                            {isPending && (
                                <section className="p-settings__two-factor-verification">
                                    <h3 className="p-settings__two-factor-verification-title">
                                        VERIFICACION DEL CODIGO TOTP
                                    </h3>

                                    <label
                                        htmlFor="two-factor-confirm-code"
                                        className="p-settings__two-factor-verification-label"
                                    >
                                        CODIGO DE 6 DIGITOS
                                    </label>
                                    <InputOTP
                                            ...
                                            {Array.from(
                                                ...
                                                (_, index) => (
                                                    <InputOTPSlot
                                                        key={index}
                                                        index={index}
                                                        className="p-settings__two-factor-otp-slot"
                                                    />
                                                ),
                                            )}
                                        </InputOTPGroup>
                                    ...
                                    <p className="p-settings__two-factor-subtext">
                                        Introduce el codigo generado por tu app
                                        autenticadora para activar el 2FA.
                                    </p>
